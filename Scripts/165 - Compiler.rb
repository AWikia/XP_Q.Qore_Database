...
def pbGetExceptionMessage(e,script="")
  emessage=e.message
  if e.is_a?(Hangup)
    emessage="The script is taking too long. The game will restart. If this happens constantly, this may be due to the weak processor or RAM"
             ...
             loop do
               ...
               for i in 0...schema.length
                 ...
                 if key=="EggMoves"
                   ...
                   raise _INTL("Kind {1} is greater than 30 characters long (section {2}, PBS/pokemon.txt)",value,currentmap) if value.length>30
                   ...
                   raise _INTL("Species name {1} is greater than 30 characters long (section {2}, PBS/pokemon.txt)",value,currentmap) if value.length>30
    ...
    if mapid
      ...
      if thisenc && (thisenc[1][EncounterTypes::Land] ||
                     ...
                     (thisenc[1][EncounterTypes::Cave]  ||
                      thisenc[1][EncounterTypes::CaveNight]
                     )
