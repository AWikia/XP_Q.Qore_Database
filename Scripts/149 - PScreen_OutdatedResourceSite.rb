class PokemonOutdatedResourceSiteScreenScene
  def update
  ...
  def pbStartScene
    ...
    @sprites["header"]=Window_UnformattedTextPokemon.newWithSize(_INTL("Unsupported Resource Site Emulator"),
  ...
  def pbDisplaySysReqScreen
    ...
    textPositions=[
       [_INTL("Qora Qore is no longer supported in this emulator!"),258,0,2,baseColor,shadowColor],
       [_INTL("In order to continue exploring the latest development"),0,64,0,baseColor,shadowColor],
       [_INTL("done to Qore Qore, you must switch to a Level 1 or"),0,96,0,baseColor,shadowColor],
       [_INTL("higher Resource Site Emulator as the current emulator "),0,128,0,baseColor,shadowColor],
       [_INTL("is incapable of emulating some of the recent features"),0,160,0,baseColor,shadowColor],
       [_INTL("added into the game."),0,192,0,baseColor,shadowColor],
    ]
...
class PokemonOutdatedResourceSiteScreen
