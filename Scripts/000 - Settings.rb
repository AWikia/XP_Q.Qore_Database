...
#           level 2 boxes and how Trainer-battle only tasks will behave)
#      - The Global Variable that is used to record the percentage of the 
#           Balance Meter (Updates itself upon a new box is started or when 0)
