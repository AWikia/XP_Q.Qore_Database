...
def renderLineBrokenChunksWithOutline(bitmap,xDst,yDst,normtext,maxheight,baseColor,shadowColor)
  for i in 0...normtext.length
    width=normtext[i][3]
    textx=normtext[i][1]+xDst
    texty=normtext[i][2]+yDst
...
def drawTextEx(bitmap,x,y,width,numlines,text,baseColor,shadowColor,outline=false)
  ...
  if !outline
    ...
    renderLineBrokenChunksWithOutline(bitmap,x,y,normtext,numlines*32,
       baseColor,shadowColor)
  end
end
