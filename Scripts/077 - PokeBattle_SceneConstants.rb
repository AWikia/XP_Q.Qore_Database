...
#  MESSAGEBASECOLOR      = Color.new(160,160,168)
  ...
  BOXTEXTBASECOLOR        = Color.new(248,248,240)   # Was Color.new(255,255,255)
  BOXTEXTSHADOWCOLOR      = Color.new(72,88,88)      # Was Color.new(0,0,0) 
  BOXTEXTBASECOLOR2        = Color.new(88,88,80)
  BOXTEXTSHADOWCOLOR2      = Color.new(168,184,184) 
  ...
  SAFARIBOX_X = Graphics.width - 256 # Was 232
